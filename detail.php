    ...
    <div class="container-fluid py-6 px-5">
        <div class="row g-5">
            <div class="col-lg-8">
                <!-- Blog Detail Start -->
                <div class="mb-5">
                    <img class="img-fluid w-100 rounded mb-5" src="<?=ASSETS_PATH?>img/blog-2.jpg" alt="">
                ...
                <div class="mb-5">
                    ...
                    <div class="d-flex mb-4">
                        <img src="<?=ASSETS_PATH?>img/user.jpg" class="img-fluid" style="width: 45px; height: 45px;">
                        <div class="ps-3">
            ...
            <div class="col-lg-4">
                ...
                <div class="mb-5">
                    ...
                    <div class="bg-light p-4">
                        <div class="d-flex mb-3">
                            <img class="img-fluid" src="<?=ASSETS_PATH?>img/blog-1.jpg" style="width: 100px; height: 100px; object-fit: cover;" alt="">
                            <a href="" class="h6 d-flex align-items-center bg-white text-uppercase px-3 mb-0">Lorem ipsum dolor sit amet consec adipis
                            </a>
                        </div>
                        <div class="d-flex mb-3">
                            <img class="img-fluid" src="<?=ASSETS_PATH?>img/blog-2.jpg" style="width: 100px; height: 100px; object-fit: cover;" alt="">
                            <a href="" class="h6 d-flex align-items-center bg-white text-uppercase px-3 mb-0">Lorem ipsum dolor sit amet consec adipis
                            </a>
                        </div>
                        <div class="d-flex mb-3">
                            <img class="img-fluid" src="<?=ASSETS_PATH?>img/blog-3.jpg" style="width: 100px; height: 100px; object-fit: cover;" alt="">
                            <a href="" class="h6 d-flex align-items-center bg-white text-uppercase px-3 mb-0">Lorem ipsum dolor sit amet consec adipis
                            </a>
                        </div>
                        <div class="d-flex mb-3">
                ...
                <!-- Image Start -->
                <div class="mb-5">
                    <img src="<?=ASSETS_PATH?>img/blog-1.jpg" alt="" class="img-fluid rounded">
                </div>
                <!-- Image End -->
